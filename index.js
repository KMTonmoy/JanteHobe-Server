...
const uri = 'mongodb+srv://tonmoyahamed2009:jantehobe198@cluster0.ojkh8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
async function run() {
    try {
        ...
        const bannerCollection = client.db("JanteHobe").collection("BannerCollection");
        const usersCollection = client.db("JanteHobe").collection("users");
        const editorContentCollection = client.db("JanteHobe").collection("EditorContent");
